"""
Django settings for pitzpal project.
...
SECRET_KEY = "django-insecure-5--jry2nvmuf8ev&2!2jsio15f41g+d_@ceyp(if##!51aqcrs"
...
WSGI_APPLICATION = "pitzpal.wsgi.application"
...
LANGUAGES = [
    ...
    ("ja", "日本語"),  # Japanese written in Japanese
]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "vsComputer": {  # Use the exact folder name of your Django sub-app
            "handlers": ["console", "file"],  # Tell it which handler to use
            "level": "INFO",  # Set to DEBUG so you catch absolutely everything
            "propagate": True,
        },
